...
function LVL_11 () {
    ...
    SpawnCrowd()
    Tutorial = sprites.create(assets.image`Dialogue`, SpriteKind.Tut_0)
    Tutorial.setFlag(SpriteFlag.Invisible, false)
    tiles.placeOnTile(Tutorial, tiles.getTileLocation(14, 53))
...
sprites.onOverlap(SpriteKind.Player, SpriteKind.Tut_0, function (sprite, otherSprite) {
    ...
    game.showLongText("Don't get hit or you'll get sent back to the last checkpoint!", DialogLayout.Center)
})
let Walking = false
